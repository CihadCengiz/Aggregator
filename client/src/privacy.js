...
export default function privacy() {
  return (
    <Container className="pt-3">
      <h1>Privacy Policy for workOK</h1>

      <p>
        At workOK, accessible from workok.com, one of our main priorities is the
        privacy of our visitors. This Privacy Policy document contains types of
        information that is collected and recorded by workOK and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in workOK. This policy is not applicable to any
      ...
      <p>
        workOK follows a standard procedure of using log files. These files log
      ...
      <p>
        ...
        advertising partners of workOK.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on workOK, which are sent directly
      ...
      <p>
        Note that workOK has no access to or control over these cookies that are
      ...
      <p>
        workOK's Privacy Policy does not apply to other advertisers or websites.
      ...
      <p>
        workOK does not knowingly collect any Personal Identifiable Information
