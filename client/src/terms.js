...
export default function terms() {
  return (
    <Container className="pt-3">
      ...
      <p>Welcome to workOK!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of workOK's Website, located at workok.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use workOK if you do not agree to take
      ...
      <p>
        We employ the use of cookies. By accessing workOK, you agreed to use
        cookies in agreement with the workOK's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, workOK and/or its licensors own the
        intellectual property rights for all material on workOK. All
        intellectual property rights are reserved. You may access this from
        workOK for your own personal use subjected to restrictions set in these
        terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from workOK</li>
        <li>Sell, rent or sub-license material from workOK</li>
        <li>Reproduce, duplicate or copy material from workOK</li>
        <li>Redistribute content from workOK</li>
      </ul>
      ...
      <p>
        ...
        workOK does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of workOK,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, workOK shall not be liable for the
      ...
      <p>
        workOK reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant workOK a non-exclusive license to use, reproduce, edit
      ...
      <p>
        ...
        the hyperlink compensates the absence of workOK; and (d) the link is in
      ...
      <p>
        ...
        e-mail to workOK. Please include your name, your organization name,
      ...
      <p>
        No use of workOK's logo or other artwork will be allowed for linking
